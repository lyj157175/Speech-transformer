...
# data_path
DATA_DIR = 'data'
aishell_path = 'data/data_aishell'
wav_folder = os.path.join(aishell_path, 'wav')
transcript_file = os.path.join(aishell_path, 'transcript/aishell_transcript_v0.8.txt')
